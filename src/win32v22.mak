...
# Synopsis:    Make file for Windows using Microsoft MSVC 2022
# Notes:
#       Build from the command line using nmake. 
#
#	Run "nmake -f win32v22.mak"      for optimised build produces ./me32.exe
#	Run "nmake -f win32v22.mak mec"  for console support          ./mec32.exe
#	Run "nmake -f win32v22.mak med"  for debug build produces     ./med32.exe
#
#	Run "nmake -f win32v22.mak clean"      to clean source directory
#	Run "nmake -f win32v22.mak spotless"   to clean source directory even more
#
##############################################################################
#
# Microsoft MSCV 2022 install directory
# TOOLSDIR      = c:\Program Files\Microsoft Visual Studio 8\VC
ZLIBINCDIR      = g:\zlib-win-build-1.3.1-p1
ZLIBDIR         = g:\zlib-win-build-1.3.1-p1\build-VS2022\libz\Release
#
...
CDEFS         = -D_WIN32 -I. "-I$(ZLIBINCDIR)" -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE
...
LDDEBUG       =	/DEBUG
LDOPTIMISE    =	
LDFLAGS       = /NOLOGO /INCREMENTAL:no /MACHINE:IX86 /PDB:NONE "/LIBPATH:$(ZLIBDIR)"
LIBS          = shell32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib libz.lib
CONSOLE_LIBS  = 
WINDOW_LIBS   = 
#
# Rules
